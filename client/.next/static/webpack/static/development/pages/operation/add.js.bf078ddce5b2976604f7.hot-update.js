...
var Add = /*#__PURE__*/function (_Component) {
  ...
  function Add(props) {
    ...
    Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_2__["default"])(_this), "saveArticle", function () {
      ...
      axios__WEBPACK_IMPORTED_MODULE_9___default.a.post('http://localhost:8000/blogs/add', _objectSpread({}, _this.state)).then(function (res) {
        console.log(res);
      })["catch"](function (err) {
        console.err(err);
      });
...
//# sourceMappingURL=add.js.bf078ddce5b2976604f7.hot-update.js.map