...
var Add = /*#__PURE__*/function (_Component) {
  ...
  function Add(props) {
    ...
    Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_2__["default"])(_this), "saveArticle", function () {
      ...
      axios__WEBPACK_IMPORTED_MODULE_9___default.a.post('http://localhost:8000/blogs/add', JSON.stringify(_objectSpread({}, _this.state))).then(function (res) {
        console.log(res);
      })["catch"](function (err) {
        console.error(err);
      });
...
//# sourceMappingURL=add.js.469f44eb34d82925173e.hot-update.js.map