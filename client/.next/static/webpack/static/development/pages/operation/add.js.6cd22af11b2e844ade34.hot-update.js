  ...
  function Add(props) {
    ...
    Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_2__["default"])(_this), "saveArticle", function () {
      ...
      axios__WEBPACK_IMPORTED_MODULE_8___default.a.post('http://localhost:8000/blogs/add', {
        ...
        console.log(res);
        var id = res.request.data.message._id;
        next_router__WEBPACK_IMPORTED_MODULE_9___default.a.push('/blog/id');
      })["catch"](function (err) {
        console.error(err);
      });
    });
...
//# sourceMappingURL=add.js.6cd22af11b2e844ade34.hot-update.js.map